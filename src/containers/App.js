...
class App extends Component {
  ...
  // event listners
	...
	onDrop = (e) => {
		...
		arr.unshift('<div><img src="/components/svg/Drag.svg" style="position:absolute;right:30%;margin-top:30px" height="15px" width="15px"/><b style="padding-left:30px">'+ y + '</b><img src="/components/svg/Delete.svg" onclick="destroyer(event)" style="position:absolute;margin-top:-30px; right:19%" height="15px" width="15px"/></div>');
									...
									textAlign:'center'
										...
										<div style={{
											...
											onClick={(e) => {
												...
												arr.unshift('<div class="special mostdiv"><img src="/components/svg/Drag.svg" style="margin-right:30px" height="15px" width="15px"/><b>'+p+'</b><img src="/components/svg/Delete.svg" onclick="destroyer(event)" style="position:absolute; right:19%" height="15px" width="15px"/></div>');
...
function addBreak(){
	<img src="/components/svg/Break.svg" height="15px" width="15px"/>
		arr.unshift('<div class="break mostdiv" draggable="true"><img src="/components/svg/Break.svg" style="margin-right:30px" height="15px" width="15px"/><b>Break</b> 5 min'+'<img src="/components/svg/Delete.svg" onclick="destroyer(event)" style="position:absolute; right:19%" height="15px" width="15px"/></div>');
		//console.log(arr);
		document.getElementById('panel').innerHTML = arr.join('');
	}
		...
		base('Exercises').select({
				...
				records.forEach(function(record) {
					...
					if (p.match(record.get('Name'))) {
						...
						arr.unshift('<div class="desc mostdiv" draggable="true"><img src="/components/svg/Drag.svg" style="margin-right:30px" height="15px" width="15px"/><b>'+record.get('Name')+'</b><img src="/components/svg/Delete.svg" onclick="destroyer(event)" style="position:absolute; right:19%" height="15px" width="15px"/></div>');
						document.getElementById('panel').innerHTML = arr.join('');
...
function addtoColumn(e){
	...
	base('Exercises').select({
			...
			records.forEach(function(record) {
				...
				if (p.match(record.get('Name'))) {
					console.log(p);
					arr.unshift('<div class="desc mostdiv" draggable="true" ><img src="/components/svg/Drag.svg" style="margin-right:30px" height="15px" width="15px"/><b>'+p+'</b><img src="/components/svg/Delete.svg" onclick="destroyer(event)" style="position:absolute; right:19%" height="15px" width="15px"/></div>');
